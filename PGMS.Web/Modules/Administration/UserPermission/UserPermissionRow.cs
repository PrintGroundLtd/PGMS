...
namespace PGMS.Administration.Entities
{
    ...
    [ReadPermission(PermissionKeys.UserPermissions.ReadPermission)]
    [ModifyPermission(PermissionKeys.UserPermissions.ModifyPermission)]
