...
namespace PGMS.Erp.Endpoints
{
    ...
    [Route("Services/Erp/Companies/[action]")]
    ...
    public class CompaniesController : ServiceEndpoint
    {
        ...
        public FileContentResult ListExcel(IDbConnection connection, ListRequest request)
        {
            ...
            var report = new DynamicDataReport(data, request.IncludeColumns, typeof(Columns.CompaniesColumns));
            var bytes = new ReportRepository().Render(report);
            var reportName = "Companies_";
