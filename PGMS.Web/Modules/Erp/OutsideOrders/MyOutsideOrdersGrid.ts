...
namespace PGMS.Erp {
    ...
    export class MyOutsideOrdersGrid extends Erp.OutsideOrdersGrid {
        ...
        protected createQuickFilters() {
            ...
            this.myLookupQuickFilter = this.findQuickFilter(Serenity.LookupEditor, PGMS.Erp.OutsideOrdersRow.Fields.AssignUserId);
        ...
        protected createView(): Slick.RemoteView<OutsideOrdersRow> {
            ...
            (view as any).onDataLoaded.subscribe((e, ui) => {
                this.setTitle(Q.text("Site.Dashboard.OutsideOrdersGridTitle") + this.totalRecord);
        ...
        protected onViewSubmit() {
            ...
            request.Criteria = Serenity.Criteria.and(request.Criteria,
                [['AssignUserId'], '=', Authorization.userDefinition.UserId]);
