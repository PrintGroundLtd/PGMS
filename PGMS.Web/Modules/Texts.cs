    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your PGMS Password";
                ...
                {
                    public static LocalText FormTitle = "Welcome to PGMS (Print Ground Management System)";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "PGMS";
        }
